...
DATABASES = {
    'default': {
        ...
        # 'NAME': 'shambhavi',  # name of the database
        # 'USER': 'root',
        # 'PASSWORD': '',
        # 'HOST': 'localhost',
        # 'PORT': '3306',
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = ''   # enter you email address
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Shambhavi Restaurant",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Library",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "SHAMBHAVI",
    ...
    "welcome_sign": "Welcome to ShambhaviWorld",

    # Copyright on the footer
    "copyright": "Shambhavi Restaurant",
